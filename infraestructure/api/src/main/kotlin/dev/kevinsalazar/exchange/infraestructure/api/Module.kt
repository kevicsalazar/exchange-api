...
import dev.kevinsalazar.exchange.infraestructure.api.config.EventsConfigProperties
...
val apiModule = module {
    ...
    singleOf(::EventsConfigProperties) withOptions { bind<ConfigProperties.Events>() }
